...
const SearchScreen: React.FC = () => {
  ...
  useEffect(() => {
    const updateColumns = () => {
      ...
      if (width >= 1400) setNumColumns(9);
      else if (width >= 1200) setNumColumns(8);
      else if (width >= 1000) setNumColumns(7);
      else if (width >= 800) setNumColumns(5);
      else if (width >= 600) setNumColumns(4);
