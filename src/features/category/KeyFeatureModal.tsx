...
const KeyFeaturesModal: React.FC<Props> = ({ visible, onClose, extraDetails }) => {
  return (
  ...
  {extraDetails.ingredients?.some(item => item.toLowerCase() !== 'n/a') && (
  ...
  {extraDetails.howToUse?.toLowerCase() !== 'n/a' && extraDetails.howToUse?.trim() !== '' && (
    <View style={styles.featureItem}>
  ...
  {extraDetails.flavourNote?.toLowerCase() !== 'n/a' && extraDetails.flavourNote?.trim() !== '' && (
    <View style={styles.featureItem}>
        ...
        <View style={styles.modalWrapper}>
          <View style={styles.sideModal}>
            ...
            <View style={styles.header}>
              ...
              <TouchableOpacity onPress={onClose}>
                <X size={29} color="#000" />   {/* ✅ Updated Icon */}
              </TouchableOpacity>
            </View>
            ...
            <ScrollView contentContainerStyle={styles.content}>
              ...
              {extraDetails.howToUse?.toLowerCase() !== 'n/a' &&
                extraDetails.howToUse?.trim() !== '' && (
                  <View style={styles.featureItem}>
                    <CustomText variant="h8" fontFamily={Fonts.Medium}>How to Use:</CustomText>
                    <CustomText variant="h8" style={styles.bulletText}>{extraDetails.howToUse}</CustomText>
                  </View>
              ...
              {extraDetails.flavourNote?.toLowerCase() !== 'n/a' &&
                extraDetails.flavourNote?.trim() !== '' && (
                  <View style={styles.featureItem}>
                    <CustomText variant="h8" fontFamily={Fonts.Medium}>Flavour Note:</CustomText>
                    <CustomText variant="h8" style={styles.bulletText}>{extraDetails.flavourNote}</CustomText>
                  </View>
