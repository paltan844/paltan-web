...
const KeyFeaturesModalMobile: React.FC<Props> = ({ visible, onClose, extraDetails }) => {
  return (
...
{/*
  ...
  {extraDetails.ingredients &&
    ...
    extraDetails.ingredients[0] !== 'N/A' && (
      <View style={styles.featureItem}>
        <CustomText variant="h8" fontFamily={Fonts.Medium}>Processor</CustomText>
        {extraDetails.ingredients.map((item, index) => (
          <CustomText key={index} variant="h8" style={styles.bulletText}>• {item}</CustomText>
        ))}
      </View>
  ...
  {extraDetails.howToUse && extraDetails.howToUse !== 'N/A' && (
    <View style={styles.featureItem}>
      <CustomText variant="h8" fontFamily={Fonts.Medium}>Primary Camera</CustomText>
      <CustomText variant="h8" style={styles.bulletText}>{extraDetails.howToUse}</CustomText>
    </View>
  )}
  ...
  {extraDetails.flavourNote && extraDetails.flavourNote !== 'N/A' && (
    <View style={styles.featureItem}>
      <CustomText variant="h8" fontFamily={Fonts.Medium}>Network</CustomText>
      <CustomText variant="h8" style={styles.bulletText}>{extraDetails.flavourNote}</CustomText>
    </View>
  )}
 ...
 {extraDetails.secondaryCamera && extraDetails.secondaryCamera !== 'N/A' && (
    <View style={styles.featureItem}>
      <CustomText variant="h8" fontFamily={Fonts.Medium}>Secondary Camera</CustomText>
      <CustomText variant="h8" style={styles.bulletText}>{extraDetails.secondaryCamera}</CustomText>
    </View>
  )}

   {extraDetails.display && extraDetails.display !== 'N/A' && (
    <View style={styles.featureItem}>
      <CustomText variant="h8" fontFamily={Fonts.Medium}>Display</CustomText>
      <CustomText variant="h8" style={styles.bulletText}>{extraDetails.display}</CustomText>
    </View>
  )}
...
export default KeyFeaturesModalMobile;
