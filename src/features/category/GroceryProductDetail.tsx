...
<View style={styles.featuresRow}>
  ...
  {product.dietType && product.dietType !== 'N/A' && (
    <>
      <CustomText variant="h7" style={{ marginTop: 10 }}>Diet Type</CustomText>
  ...
  {product.numberOfQuantity && product.numberOfQuantity !== 'N/A' && (
    <>
...
withline:{
 ...
 imageWrapper: {
  backgroundColor: 'rgba(201, 207, 208, 0.07)',
},
  image: {
      resizeMode: 'contain',
      width: '100%',
...
export default WithCart(GroceryProductDetail);   */
    ...
    />
          ...
          <ComparisonModal
            ...
            comparisonData={[
              {
                platform: 'Flipkart',
                price: product?.flipkartPrice === 'N/A' ? 'N/A' : `₹${product?.flipkartPrice}`,
                deliveryCharges:
                  product?.flipkartDeliveryCharges === 'N/A'
                    ? 'N/A'
                    : `₹${product?.flipkartDeliveryCharges}`,
              ...
              {
                platform: 'Amazon',
                price: product?.amazonPrice === 'N/A' ? 'N/A' : `₹${product?.amazonPrice}`,
                deliveryCharges:
                  product?.amazonDeliveryCharges === 'N/A'
                    ? 'N/A'
                    : `₹${product?.amazonDeliveryCharges}`,
              ...
              {
                platform: 'Zepto',
                price: product?.zeptoPrice === 'N/A' ? 'N/A' : `₹${product?.zeptoPrice}`,
                deliveryCharges:
                  product?.zeptoDeliveryCharges === 'N/A'
                    ? 'N/A'
                    : `₹${product?.zeptoDeliveryCharges}`,
              ...
              {
                platform: 'Blinkit',
                price: product?.blinkitPrice === 'N/A' ? 'N/A' : `₹${product?.blinkitPrice}`,
                deliveryCharges:
                  product?.blinkitDeliveryCharges === 'N/A'
                    ? 'N/A'
                    : `₹${product?.blinkitDeliveryCharges}`,
